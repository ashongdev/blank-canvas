  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-semibold text-foreground">My Templates</h2>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuSub>
                      ...
                      <DropdownMenuSubContent>
                        <DropdownMenuItem onClick={() => onAssignCollection(t.id, null)}>
                          None
                        </DropdownMenuItem>
                        {collections.map((c) => (
                          <DropdownMenuItem key={c.id} onClick={() => onAssignCollection(t.id, c.id)}>
                            {c.name}
                          </DropdownMenuItem>
                        ))}
                      </DropdownMenuSubContent>
      ...
      <Dialog open={!!editTemplate} onOpenChange={(o) => !o && setEditTemplate(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Update the template name below.</DialogDescription>
          </DialogHeader>
